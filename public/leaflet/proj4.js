          ...
          datum.prototype = {
            ...
            geocentric_to_geodetic: function (p) {
              ...
              do {
                ...
                Height =
                  P * CPHI0 + Z * SPHI0 - RN * (1.0 - this.es * SPHI0 * SPHI0);
  ...
  -----------------------------------------------------------------------*/
      ...
      -----------------*/
            ...
            if (this.sphere) {
              ...
              y =
                this.a * (Math.atan2(Math.tan(phi), Math.cos(lam)) - this.lat0);
            } else {
              //ellipsoid
        ...
        function (_dereq_, module, exports) {
          ...
          exports.inverse = function (p) {
            ...
            for (var i = MAX_ITER; i > 0; --i) {
              lat =
                2 *
                  Math.atan(num * srat(this.e * Math.sin(p.y), -0.5 * this.e)) -
                HALF_PI;
  ...
  */
    ...
    ----------------------------------------------------------*/
          ...
          exports.inverse = function (p) {
            ...
            var up =
              (vp * Math.cos(this.gamma0) + sp * Math.sin(this.gamma0)) / tp;
            var ts = Math.pow(
          ...
          exports.forward = function (p) {
            ...
            if (this.sphere) {
              ...
              if (Math.abs(this.coslat0) <= EPSLN) {
                ...
                p.y =
                  A * (this.cosX0 * sinX - this.sinX0 * cosX * Math.cos(dlon)) +
                  this.y0;
              }
              ...
              if (wkt.UNIT.convert) {
                if (wkt.type === 'GEOGCS') {
                  if (wkt.DATUM && wkt.DATUM.SPHEROID) {
                    wkt.to_meter =
                      parseFloat(wkt.UNIT.convert, 10) * wkt.DATUM.SPHEROID.a;
                  }
                } else {

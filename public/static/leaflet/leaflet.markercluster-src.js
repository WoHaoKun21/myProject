  ...
  var t = (L.MarkerClusterGroup = L.FeatureGroup.extend({
    ...
    addLayers: function (e, t) {
      ...
      if (this._map) {
        var _ = new Date().getTime(),
          d = L.bind(function () {
            for (var c = new Date().getTime(); l < h; l++) {
              if (s && l % 200 == 0) if (new Date().getTime() - c > o) break;
              if ((i = e[l]) instanceof L.LayerGroup)
                u && ((e = e.slice()), (u = !1)),
        ...
        for (var c = this._needsClustering; l < h; l++)
          (i = e[l]) instanceof L.LayerGroup
            ? (u && ((e = e.slice()), (u = !1)),
              this._extractNonGroupLayers(i, e),
              (h = e.length))
            : i.getLatLng
    ...
    onAdd: function (e) {
      ...
      for (
        ...
        ((n = this._needsRemoving[t]).newlatlng = n.layer._latlng),
  ...
  var i = (L.MarkerCluster = L.Marker.extend({
      ...
      this._recursively(
        ...
        function (e) {
          ...
          for (i = r.length - 1; i >= 0; i--)
            (n = r[i])._icon && (n._setPos(t), n.clusterHide());
        },
        function (e) {
          var i,
            n,
    ...
    _recursively: function (e, t, i, n, r) {
      var s,
        ...
        h = this._zoom;
      if ((t <= h && (n && n(this), r && h === i && r(this)), h < t || h < i))
    ...
    (L.QuickHull = {
      ...
      findMostDistantPointFromBaseLine: function (e, t) {
        ...
        for (i = t.length - 1; i >= 0; i--)
          (n = t[i]),
            (r = this.getDistant(n, e)) > 0 &&
              (a.push(n), r > s && ((s = r), (o = n)));
      ...
      buildConvexHull: function (e, t) {
        ...
        return n.maxPoint
          ? (i = (i = i.concat(
            ...
            )).concat(this.buildConvexHull([n.maxPoint, e[1]], n.newPoints)))
          : [e[0]];
      },
      getConvexHull: function (e) {
        ...
        for (t = e.length - 1; t >= 0; t--) {
          var d = e[t];
          (!1 === i || d.lat > i) && ((o = d), (i = d.lat)),
            (!1 === n || d.lat < n) && ((a = d), (n = d.lat)),
            (!1 === r || d.lng > r) && ((h = d), (r = d.lng)),
            (!1 === s || d.lng < s) && ((l = d), (s = d.lng));
        }
        return (
          n !== i ? ((_ = a), (u = o)) : ((_ = l), (u = h)),
          [].concat(
    ...
    L.MarkerCluster.include({
        ...
        if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
          ...
          this._group._unspiderfy(),
            ...
            t.length >= this._circleSpiralSwitchover
              ? (e = this._generatePointsSpiral(t.length, i))
              : ((i.y += 10), (e = this._generatePointsCircle(t.length, i))),
      ...
      _generatePointsCircle: function (e, t) {
        var i,
          ...
          s = this._2PI / e,
          o = [];
        for (r = Math.max(r, 35), o.length = e, i = 0; i < e; i++)
      ...
      _animationSpiderfy: function (e, t) {
        ...
        for (
          ...
          (n = e[i]),
            ...
            (n._spiderLeg = r),
            p &&
              ((o = (s = r._path).getTotalLength() + 0.1),
        ...
        for (
          ...
          (a = u.layerPointToLatLng(t[i])),
            ((n = e[i])._preSpiderfyLatlng = n._latlng),
            n.setLatLng(a),
            n.clusterShow && n.clusterShow(),
            p &&
              (((s = (r = n._spiderLeg)._path).style.strokeDashoffset = 0),
      ...
      _animationUnspiderfy: function (e) {
        ...
        for (
          ...
          (t = d[i])._preSpiderfyLatlng &&
            ...
            o && u.removeLayer(t),
            c &&
              ((s = (r = (n = t._spiderLeg)._path).getTotalLength() + 0.1),
              (r.style.strokeDashoffset = s),
              n.setStyle({ opacity: 0 })));
        (h._ignoreMove = !1),
          setTimeout(function () {
            var e = 0;
            for (i = d.length - 1; i >= 0; i--) (t = d[i])._spiderLeg && e++;

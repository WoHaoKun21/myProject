!(function (t, i) {
  ...
  (S.extend = function (t) {
    ...
    var o = (n.__super__ = this.prototype),
      s = e(o);
    for (var r in (((s.constructor = n).prototype = s), this))
    ...
    return (
      'touchstart' === i
        ? ((l = t),
          ...
          (l['_leaflet_touchstart' + _] = d),
          l.addEventListener(At, d, !1),
          Dt ||
        ...
        : 'touchmove' === i
        ? ((u = e),
          ((h = t)['_leaflet_touchmove' + n] = p),
          h.addEventListener(It, p, !1))
        : 'touchend' === i &&
          ((a = e),
          ((r = t)['_leaflet_touchend' + n] = s),
          r.addEventListener(Ot, s, !1),
          r.addEventListener(Rt, s, !1)),
      this
    );
  }
  function Wt(t) {
  ...
  var Vt,
    ...
    Yt,
    Xt,
    Jt = Pt ? 'MSPointerDown' : Lt ? 'pointerdown' : 'touchstart',
    $t = Pt ? 'MSPointerUp' : Lt ? 'pointerup' : 'touchend',
    Qt = '_leaflet_',
    ti = fi([
      'transform',
      'webkitTransform',
  ...
  function Pi(t) {
    ...
    t.style &&
      (Li(),
      (Xt = (Yt = t).style.outline),
      (t.style.outline = 'none'),
      zi(window, 'keydown', Li));
  }
  function Li() {
    Yt &&
      ((Yt.style.outline = Xt), (Xt = Yt = void 0), Si(window, 'keydown', Li));
  }
  function bi(t) {
    for (
      ;
  ...
  Kt =
    'onselectstart' in document
      ...
      : ((qt = fi([
        ...
        function () {
          qt && ((document.documentElement.style[qt] = Vt), (Vt = void 0));
        });
  var Mi = {
    TRANSFORM: ti,
    TRANSITION: ii,
  ...
  function zi(t, i, e, n) {
    ...
    else for (var s = 0, r = (i = _(i)).length; s < r; s++) ki(t, i[s], e, n);
    return this;
  }
  ...
  function Si(t, i, e, n) {
    if ('object' == typeof i) for (var o in i) Bi(t, o, i[o], e);
      ...
      for (var s = 0, r = (i = _(i)).length; s < r; s++) Bi(t, i[s], e, n);
    else {
  ...
  function ki(t, i, e, n) {
    ...
    function p(t) {
      ...
      var i = Date.now(),
        e = i - (u || i);
      (l = t.touches ? t.touches[0] : t), (c = 0 < e && e <= 250), (u = i);
    }
    function m(t) {
      if (c && !l.cancelBubble) {
        if (Lt) {
          ...
          var i,
            e,
            n = {};
          for (e in l) (i = l[e]), (n[e] = i && i.bind ? i.bind(l) : i);
          l = n;
        }
        (l.type = 'dblclick'), (l.button = 0), a(l), (u = null);
      }
    }
    Lt && 0 === i.indexOf('touch')
      ...
      ? ((a = _),
        ...
        s.addEventListener($t, m, !!Ct && { passive: !1 }),
      ...
      ? 'touchstart' === i ||
        ...
        'wheel' === i ||
        'mousewheel' === i
        ? t.addEventListener(Ei[i] || i, _, !!Ct && { passive: !1 })
        : 'mouseenter' === i || 'mouseleave' === i
        ? ((_ = function (i) {
            (i = i || window.event), Vi(t, i) && d(i);
          }),
          t.addEventListener(Ei[i], _, !1))
        : t.addEventListener(i, d, !1)
      : 'attachEvent' in t && t.attachEvent('on' + i, _),
      (t[Ci] = t[Ci] || {}),
      (t[Ci][o] = _);
  }
  function Bi(t, i, e, n) {
    ...
    if (!p) return this;
    Lt && 0 === i.indexOf('touch')
      ? ((_ = (l = t)['_leaflet_' + (c = i) + d]),
        'touchstart' === c
          ? l.removeEventListener(At, _, !1)
          : 'touchmove' === c
          ? l.removeEventListener(It, _, !1)
          : 'touchend' === c &&
            (l.removeEventListener(Ot, _, !1),
            l.removeEventListener(Rt, _, !1)))
      : bt && 'dblclick' === i && !Zi()
      ? ((a = (o = t)[Qt + Jt + (s = d)]),
        (h = o[Qt + $t + s]),
        (u = o[Qt + 'dblclick' + s]),
        o.removeEventListener(Jt, a, !!Ct && { passive: !1 }),
        o.removeEventListener($t, h, !!Ct && { passive: !1 }),
        o.removeEventListener('dblclick', u, !1))
      : 'removeEventListener' in t
      ? t.removeEventListener(Ei[i] || i, p, !1)
  ...
  var qi = {
    ...
    Ki = E.extend({
      ...
      flyTo: function (t, i, e) {
        if (!1 === (e = e || {}).animate || !vt) return this.setView(t, i, e);
        this._stop();
        ...
        return (
          ...
          function e() {
            var s,
              h,
              c = (Date.now() - g) / y,
              _ = ((s = c), (1 - Math.pow(1 - s, 1.5)) * v);
            c <= 1
              ? ((this._flyToFrame = M(e, this)),
                this._move(
                  this.unproject(n.add(o.subtract(n).multiplyBy(f(_) / u)), r),
                  this.getScaleZoom(
                    a / ((h = _), a * (p(m) / p(m + l * h))),
                    r,
                  ),
      ...
      _initContainer: function (t) {
        ...
        zi(i, 'scroll', this._onScroll, this), (this._containerId = r(i));
      },
      ...
      _fireDOMEvent: function (t, e, n) {
        ...
        if (
          ...
          var s = n[0];
          'contextmenu' === e && s.listens(e, !0) && Ri(t);
          var r,
            a = { originalEvent: t };
          'keypress' !== t.type &&
            'keydown' !== t.type &&
            'keyup' !== t.type &&
            ((r = s.getLatLng && (!s._radius || s._radius <= 10)),
            (a.containerPoint = r
  ...
  function Ve(t, e) {
    return t.feature ? i({}, t.feature, { geometry: e }) : qe(e);
  }
  function qe(t) {
    ...
    ze.include({
      toMultiPoint: function (t) {
        ...
        return (
          ...
          Ve(this, { type: 'MultiPoint', coordinates: i })
        );
      },
      toGeoJSON: function (t) {
        var i =
        ...
        return (
          this.eachLayer(function (i) {
            ...
            i.toGeoJSON &&
              ...
              e
                ? n.push(o.geometry)
                : 'FeatureCollection' === (s = qe(o)).type
                ? n.push.apply(n, s.features)
                : n.push(s));
          }),
          e
            ? Ve(this, { geometries: n, type: 'GeometryCollection' })
  ...
  var on = Me.extend({
    ...
    sn = on.extend({
      ...
      createTile: function (t, i) {
        ...
        return (
          zi(e, 'load', o(this._tileOnLoad, this, i, e)),
          zi(e, 'error', o(this._tileOnError, this, i, e)),
          (!this.options.crossOrigin && '' !== this.options.crossOrigin) ||
            (e.crossOrigin =
              !0 === this.options.crossOrigin ? '' : this.options.crossOrigin),
          (e.alt = ''),
      ...
      getTileUrl: function (t) {
        ...
        return (
          this._map &&
            ...
            (n['-y'] = e)),
          f(this._url, i(n, this.options))
        );
      },
      _tileOnLoad: function (t, i) {
        it ? setTimeout(o(t, this, null, i), 0) : t(null, i);
      },
  ...
  var an = sn.extend({
    ...
    initialize: function (t, e) {
      ...
      var s = (e = d(this, e)).detectRetina && zt ? 2 : 1,
        r = this.getTileSize();
  ...
  var hn = Me.extend({
    ...
    un = hn.extend({
      ...
      _initPath: function (t) {
        ...
        var i = ((this._layers[r(t)] = t)._order = {
          layer: t,
          prev: this._drawLast,
          next: null,
        });
